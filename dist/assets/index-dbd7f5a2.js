...
const API_BASE_URL = "http://kojkhj614.dothome.co.kr/api";
...
const AuthProvider = ({ children }) => {
  ...
  const changePassword = async (currentPassword, newPassword) => {
    try {
      ...
      console.error("Password change error:", error2);
      return { success: false, error: error2.message };
    } finally {
      setLoading(false);
    }
...
function loopFix(_temp) {
  ...
  if (typeof activeSlideIndex === "undefined") {
    activeSlideIndex = swiper2.getSlideIndex(slides.find((el2) => el2.classList.contains(params.slideActiveClass)));
  } else {
...
const events = (swiper2, method) => {
  ...
  el2[domMethod]("touchstart", swiper2.onTouchStart, {
    passive: false
  });
...
let Swiper$1 = class Swiper {
  ...
  mount(element) {
    ...
    el2.swiper = swiper2;
    if (el2.parentNode && el2.parentNode.host && el2.parentNode.host.nodeName === swiper2.params.swiperElementNodeName.toUpperCase()) {
...
function Navigation(_ref) {
  ...
  function getEl(el2) {
    ...
    if (el2 && typeof el2 === "string" && swiper2.isElement) {
      res = swiper2.el.querySelector(el2) || swiper2.hostEl.querySelector(el2);
      if (res)
        return res;
    }
    if (el2) {
      ...
      if (swiper2.params.uniqueNavElements && typeof el2 === "string" && res && res.length > 1 && swiper2.el.querySelectorAll(el2).length === 1) {
  ...
  function onBulletClick(e) {
    ...
    if (swiper2.params.loop) {
      if (swiper2.realIndex === index2)
        return;
      const moveDirection = getMoveDirection(swiper2.realIndex, index2, swiper2.slides.length);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      ...
      children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "animate-spin -ml-1 mr-2 h-4 w-4 text-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [
...
const Home = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Swiper2,
      {
        ...
        navigation: true,
        className: "h-full",
        children: heroImages.map((slide2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `h-full w-full ${!slide2.customBackground ? "bg-cover bg-center" : ""}`,
            style: !slide2.customBackground ? { backgroundImage: `url(${slide2.image})` } : {},
            children: [
              slide2.customBackground ? (
                // 특별한 혜택 슬라이드의 커스텀 배경
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-kong-gold/20 via-kong-black to-kong-black" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/4 w-1/2 h-1/2 bg-kong-gold/10 blur-[100px] rounded-full" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 right-1/4 w-1/2 h-1/2 bg-kong-gold/5 blur-[100px] rounded-full" })
                  ] })
                ] })
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-full flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-bold mb-4", children: slide2.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl mb-8", children: slide2.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "lg", variant: "primary", children: "쇼핑하기" })
                  ]
                }
              ) }) })
            ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 px-4 max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-gray-900", children: "추천 상품" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/products",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8", children: products.map((product, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          animate: { opacity: 1, y: 0 },
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: `/products/${product.id}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: product.brand }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: product.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg font-semibold text-primary mt-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 px-4 max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "카테고리" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 max-w-2xl mx-auto", children: "다양한 카테고리의 상품들을 만나보세요" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8", children: [
        {
          name: "의류",
          icon: Shirt,
          color: "bg-[#FF6B6B]",
      ...
      ].map((category, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          animate: { opacity: 1, y: 0 },
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/category/${category.name}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-square relative overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: category.image,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-colors duration-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 p-6 flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${category.color} p-3 rounded-2xl`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(category.icon, { className: "w-6 h-6 text-white" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-white mb-2 group-hover:translate-x-2 transition-transform duration-300", children: category.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm group-hover:translate-x-2 transition-transform duration-300 delay-75", children: category.description })
              ] })
            ] })
          ] }) })
        },
...
const ProductDetail = () => {
  ...
  const product = products.find((p2) => p2.id === parseInt(id2));
  if (!product) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-4", children: "상품을 찾을 수 없습니다" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => window.history.back(),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "space-y-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square rounded-2xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: product.image,
                alt: product.name,
            ...
            product.additionalImages && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: product.additionalImages.map((image, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: image,
                alt: `${product.name} ${index2 + 1}`,
                className: "w-full h-full object-cover"
              }
            ) }, index2)) })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-kong-gray-900", children: product.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-kong-gray-600 mt-2", children: product.brand })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-bold text-kong-gray-900", children: [
              product.price.toLocaleString(),
              "원"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kong-gray-600", children: product.description }),
            product.sizes && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-kong-gray-900 mb-3", children: "사이즈" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: product.sizes.map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setSelectedSize(size),
                  className: `py-2 text-center rounded-md border ${selectedSize === size ? "border-kong-gold bg-kong-gold text-white" : "border-kong-gray-300 text-kong-gray-700 hover:border-kong-gold"}`,
                  children: size
                },
                size
              )) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-kong-gray-900 mb-3", children: "수량" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-kong-gray-900", children: quantity }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => handleQuantityChange(1),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "primary", className: "flex-1", onClick: handleAddToCart, children: "장바구니" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "outline", className: "flex-1", children: "바로구매" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => toggleWishlist(product),
                  className: "p-4 rounded-full border border-kong-gray-300 hover:border-kong-gold",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-6 h-6 text-kong-gray-600" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-kong-gray-200 pt-6 mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: features.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(feature.icon, { className: "w-5 h-5 text-kong-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-kong-gray-900", children: feature.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-kong-gray-500", children: feature.description })
              ] })
            ] }, feature.title)) }) })
          ]
        }
...
const Cart = () => {
  ...
  const [showCoupon, setShowCoupon] = reactExports.useState(false);
  const [couponCode, setCouponCode] = reactExports.useState("");
  const [appliedCoupon, setAppliedCoupon] = reactExports.useState(null);
  const [selectedItems, setSelectedItems] = reactExports.useState(cart.map((item) => ({ ...item, selected: true })));
  const coupons = [
    { code: "WELCOME10", discount: 10, type: "percent" },
    { code: "FREESHIP", discount: 3e3, type: "fixed" }
  ];
  const handleQuantityChange = (id2, newQuantity) => {
    updateCartQuantity(id2, newQuantity);
    setSelectedItems((prev) => prev.map(
      (item) => item.id === id2 ? { ...item, quantity: Math.max(1, newQuantity) } : item
    ));
  };
  const handleRemoveItem = (id2) => {
    removeFromCart(id2);
    setSelectedItems((prev) => prev.filter((item) => item.id !== id2));
  };
  const toggleSelect = (id2) => {
    setSelectedItems(
      (prev) => prev.map(
        (item) => item.id === id2 ? { ...item, selected: !item.selected } : item
      )
    );
  };
  const selectAll = () => {
    ...
    setSelectedItems(
      (prev) => prev.map((item) => ({ ...item, selected: !allSelected }))
    );
  };
  const applyCoupon = () => {
  ...
  const shippingFee = subtotal >= 5e4 ? 0 : 3e3;
  ...
  if (cart.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-gray-900 mb-4", children: "장바구니가 비어있습니다" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/products",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: "/products",
        className: "flex items-center text-gray-600 hover:text-primary transition-colors",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-5 h-5 mr-1" }),
          "쇼핑 계속하기"
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-gray-900", children: "장바구니" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: selectAll,
              className: "text-sm text-gray-600 hover:text-primary transition-colors",
              children: selectedItems.every((item) => item.selected) ? "전체 선택 해제" : "전체 선택"
            }
          )
        ] }),
        selectedItems.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-card p-8 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "장바구니가 비어있습니다." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/products",
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 20 },
            animate: { opacity: 1, y: 0 },
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: item.brand }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-gray-900", children: item.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary font-semibold mt-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4 mt-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-12 text-center", children: item.quantity }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      onClick: () => handleQuantityChange(item.id, item.quantity + 1),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-card p-6 sticky top-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-900 mb-4", children: "주문 요약" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "상품 금액" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "배송비" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-900", children: shippingFee === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "무료" }) : `${shippingFee.toLocaleString()}원` })
          ] }),
          appliedCoupon && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "할인" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-primary/10 text-primary px-2 py-1 rounded", children: appliedCoupon.code }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-900", children: "총 주문 금액" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "쿠폰 적용" }),
                  showCoupon ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showCoupon && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-gray-500", children: [
                    "사용 가능한 쿠폰:",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-1 space-y-1", children: coupons.map((coupon) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      coupon.code,
                      " -",
                      " ",
                      coupon.type === "percent" ? `${coupon.discount}% 할인` : `${coupon.discount.toLocaleString()}원 할인`
                    ] }, coupon.code)) })
                  ] })
                ]
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `w-full py-3 rounded-lg transition-colors ${selectedCartItems.length === 0 ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-primary text-white hover:bg-primary-dark"}`,
              children: [
...
const ProductCard = ({ product }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative bg-white rounded-xl shadow-card hover:shadow-card-hover transition-all overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/products/${product.id}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: product.image,
        alt: product.name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: product.brand }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "p-2 text-gray-400 hover:text-primary transition-colors",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-5 h-5" })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/products/${product.id}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900 mb-2 hover:text-primary transition-colors", children: product.name }) }),
...
const Wishlist = () => {
  ...
  const filteredItems = filter2 === "all" ? wishlist : wishlist.filter((item) => item.category === filter2);
  const handleRemove = (id2) => {
    removeFromWishlist(id2);
  };
  ...
  if (wishlist.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-custom py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-16 h-16 text-gray-300 mx-auto mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-gray-900 mb-4", children: "찜한 상품이 없습니다" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-8", children: "관심 있는 상품을 찜해보세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/products",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-custom py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-8", children: "찜한 상품" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-8", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: `px-4 py-2 rounded-full ${filter2 === category.id ? "bg-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`,
        onClick: () => setFilter(category.id),
        children: category.name
      },
      category.id
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: filteredItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square", children: [
            ...
            item.isSoldOut && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold", children: "품절" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: item.brand }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium line-clamp-2", children: item.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg font-semibold mt-2", children: [
              item.price.toLocaleString(),
              "원"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2 right-2 flex space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
const MyKongDoo = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-custom py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-8", children: "마이 콩두" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b mb-8", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: `px-6 py-3 font-medium ${activeTab === tab.id ? "border-b-2 border-primary text-primary" : "text-gray-500 hover:text-gray-700"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
      activeTab === "reviews" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-4", children: "내 리뷰" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: reviews.map((review) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: review.product.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center space-x-2 mt-2", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-gray-600", children: review.content }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mt-2", children: review.date })
              ] })
            ] })
          },
          review.id
      ...
      activeTab === "earnings" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-4", children: "수익 현황" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: "총 수익" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: "이번 달 수익" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FiDollarSign, { className: "text-primary" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-bold", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: "지난 달 수익" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FiDollarSign, { className: "text-primary" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-bold", children: [
      ...
      activeTab === "suggestions" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-4", children: "상품 제안" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: "새로운 상품 아이디어를 제안해주세요" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-primary", children: "제안하기" })
        ] })
      ] })
    ] })
  ] });
...
const Agency = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-custom py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold mb-4", children: "콩두 에이전시" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-600 max-w-2xl mx-auto", children: "SNS 마케팅 전문가들이 함께하는 성공적인 브랜드 마케팅 솔루션" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-8", children: "서비스" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-4", children: "콘텐츠 제작" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "전문적인 촬영과 편집으로 브랜드의 아이덴티티를 살린 고퀄리티 콘텐츠를 제작합니다." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-4", children: "SNS 운영" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "브랜드의 목표에 맞는 맞춤형 SNS 운영 전략을 수립하고 지속적인 관리로 성과를 창출합니다." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-4", children: "인플루언서 마케팅" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "브랜드와 어울리는 인플루언서를 발굴하고 협업하여 효과적인 마케팅을 진행합니다." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-8", children: "포트폴리오" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Swiper2,
        {
          ...
          autoplay: { delay: 5e3 },
          pagination: { clickable: true },
          children: portfolioItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border rounded-lg overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: item.image,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-2", children: item.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: item.description })
            ] })
          ] }) }, item.id))
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-8", children: "문의하기" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 mb-2", children: "이름" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 mb-2", children: "이메일" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "email",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 mb-2", children: "연락처" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "tel",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 mb-2", children: "예산" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                name: "budget",
                ...
                required: true,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "선택해주세요" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "100-300", children: "100-300만원" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "300-500", children: "300-500만원" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "500-1000", children: "500-1000만원" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1000+", children: "1000만원 이상" })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 mb-2", children: "상품 종류" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 mb-2", children: "문의 내용" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              name: "message",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn-primary w-full", children: "문의하기" })
      ] })
    ] })
  ] });
};
const BrandZone = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: "브랜드존" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 max-w-2xl mx-auto", children: "프리미엄 브랜드의 특별한 제품들을 만나보세요" })
    ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "필터" }),
              showFilters ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: filters.map((filter2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: filter2.id, children: filter2.label }, filter2.id))
          }
        )
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: brands.map((brand) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: `/brand/${brand.id}`,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square", children: [
            ...
            brand.isNew && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-4 right-4 px-3 py-1 bg-primary text-white text-sm rounded-full", children: "NEW" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-900", children: brand.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: brand.category })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: brand.description }),
...
const BrandDetail = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[300px] md:h-[400px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: brand.banner,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-white", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: brand.logo,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-2", children: brand.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-4", children: brand.description }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-custom", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b mb-8 mt-8", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: `px-6 py-3 font-medium ${activeTab === tab.id ? "border-b-2 border-primary text-primary" : "text-gray-500 hover:text-gray-700"}`,
          onClick: () => setActiveTab(tab.id),
      ...
      activeTab === "products" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6", children: brand.products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product }, product.id)) }),
      activeTab === "posts" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6", children: brand.posts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg overflow-hidden shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: post.image,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium mb-2", children: post.title }),
      ...
      activeTab === "about" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto prose", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "브랜드 스토리" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "달바는 자연의 순수한 성분을 담아 피부 본연의 건강함을 되찾아주는 스킨케어 브랜드입니다. 화이트 트러플과 같은 프리미엄 원료를 사용하여 피부에 영양과 활력을 전달합니다." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "브랜드 철학" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "우리는 피부 건강을 위한 가장 순수하고 효과적인 솔루션을 제공하기 위해 끊임없이 연구하고 있습니다. 자연과 과학의 조화를 통해 최상의 스킨케어 경험을 선사합니다." })
      ] })
    ] })
  ] });
};
const Login = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-6 text-center text-3xl font-extrabold text-kong-gray-900", children: "KONGDOOMALL에 오신 것을 환영합니다" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-center text-sm text-kong-gray-600", children: [
        "또는",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/register", className: "font-medium text-kong-gold hover:text-kong-gold-dark", children: "회원가입" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-8 space-y-6", onSubmit: handleSubmit, children: [
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-50 text-red-500 p-4 rounded-md text-sm", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md shadow-sm -space-y-px", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", className: "sr-only", children: "이메일" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "email",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "password", className: "sr-only", children: "비밀번호" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "password",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "remember-me", className: "ml-2 block text-sm text-kong-gray-900", children: "로그인 상태 유지" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
const Register = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-6 text-center text-3xl font-extrabold text-kong-gray-900", children: "회원가입" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-center text-sm text-kong-gray-600", children: [
        "이미 계정이 있으신가요?",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "font-medium text-kong-gold hover:text-kong-gold-dark", children: "로그인" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-8 space-y-6", onSubmit: handleSubmit, children: [
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-50 text-red-500 p-4 rounded-md text-sm", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md shadow-sm -space-y-px", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "name", className: "sr-only", children: "이름" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "name",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "confirmPassword", className: "sr-only", children: "비밀번호 확인" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "confirmPassword",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "phone", className: "sr-only", children: "전화번호" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "phone",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "address", className: "sr-only", children: "주소" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "address",
...
const ForgotPassword = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-6 text-center text-3xl font-extrabold text-gray-900", children: "비밀번호 재설정" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-center text-sm text-gray-600", children: "가입하신 이메일 주소를 입력하시면 임시 비밀번호를 보내드립니다." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-8 space-y-6", onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md shadow-sm -space-y-px", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", className: "sr-only", children: "이메일 주소" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "email",
      ...
      success && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-green-500 text-sm text-center", children: success }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button$1,
        {
          type: "submit",
          className: "w-full",
          disabled: loading,
          children: loading ? "처리 중..." : "비밀번호 재설정"
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
...
const NotFound = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-6xl font-bold text-kong-gold mb-4", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-kong-black mb-4", children: "페이지를 찾을 수 없습니다" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kong-gray-600 mb-8", children: "요청하신 페이지가 존재하지 않거나 이동되었을 수 있습니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
...
const Products = () => {
  const [showFilters, setShowFilters] = reactExports.useState(false);
  const [sortBy, setSortBy] = reactExports.useState("popular");
  const [priceRange, setPriceRange] = reactExports.useState([0, 1e6]);
  const products = [
    {
      id: 1,
      name: "프리미엄 스웨터",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `md:w-64 ${showFilters ? "block" : "hidden md:block"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-card p-6 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "필터" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setShowFilters(!showFilters),
            className: "md:hidden text-gray-500 hover:text-primary",
            children: showFilters ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5" })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-gray-900 mb-2", children: "가격 범위" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-gray-900 mb-2", children: "카테고리" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: ["의류", "신발", "가방", "악세서리"].map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "rounded text-primary focus:ring-primary" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-gray-900", children: "전체 상품" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "popular", children: "인기순" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "newest", children: "최신순" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "price-low", children: "낮은 가격순" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "price-high", children: "높은 가격순" })
              ]
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product }, product.id)) })
    ] })
  ] }) }) });
};
const SocialMarketing = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-20 bg-gradient-to-br from-kong-gold/5 via-white to-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        animate: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-bold text-gray-900 mb-6", children: "SNS 마케팅 + 유통 통합 대행" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-gray-600 mb-4", children: [
            '"상품만 준비하세요.',
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            '마케팅부터 판매까지 전부 해결해드립니다."'
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-gray-600 mb-8 max-w-3xl mx-auto", children: [
            "브랜드는 제품만 준비하세요.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "SNS 광고, 콘텐츠 제작, 홈페이지 운영, 유통까지 – 전부 저희가 책임집니다."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "lg", variant: "primary", children: "서비스 시작하기" })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "제공 서비스" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "통합적인 마케팅 솔루션을 제공합니다" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: services.map((service, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          animate: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(service.icon, { className: "w-12 h-12 text-kong-gold mb-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-3", children: service.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 whitespace-pre-line", children: service.description })
          ]
        },
        service.title
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "서비스 차별점" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "콩두몰만의 특별한 혜택을 확인하세요" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: benefits.map((benefit, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          animate: { opacity: 1, y: 0 },
          transition: { duration: 0.5, delay: index2 * 0.1 },
          className: "group relative rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square relative bg-white p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${benefit.color} p-3 rounded-2xl w-fit`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(benefit.icon, { className: "w-6 h-6 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-gray-900 mb-2 group-hover:translate-x-2 transition-transform duration-300", children: benefit.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm group-hover:translate-x-2 transition-transform duration-300 delay-75", children: benefit.description })
            ] })
          ] }) })
        },
        benefit.title
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        animate: { opacity: 1, y: 0 },
        transition: { duration: 0.8 },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-8", children: "지금 바로 시작하세요" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "lg", variant: "primary", children: "상담 신청하기" })
        ]
      }
    ) }) })
  ] });
...
const Partners = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-24 overflow-hidden bg-gradient-to-b from-white to-gray-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 -z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-[#FF6B6B]/10 via-transparent to-[#4ECDC4]/10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-1/2 -translate-x-1/2 w-[120%] h-full bg-[radial-gradient(circle_at_center,rgba(255,107,107,0.05)_0%,transparent_50%)]" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            viewport: { once: true },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-bold text-gray-900 mb-6", children: "새로운 수익창출의 기회" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-gray-600 max-w-3xl mx-auto mb-8", children: "당신의 영향력을 수익으로 전환하세요. 콩두몰과 함께라면 파트너스로서 안정적인 수익을 창출할 수 있습니다." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-16", children: [
          {
            title: "간편한 시작",
        ...
        ].map((feature, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { opacity: 0, y: 20 },
            whileInView: { opacity: 1, y: 0 },
            transition: { duration: 0.5, delay: index2 * 0.2 },
            viewport: { once: true },
            className: "relative group",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full border border-gray-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${feature.color} w-14 h-14 rounded-xl flex items-center justify-center mb-6`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(feature.icon, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-gray-900 mb-3", children: feature.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: feature.description })
            ] })
          },
          feature.title
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-bold text-[#FF6B6B] mb-2", children: "10,000+" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "활성 파트너스" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-bold text-[#4ECDC4] mb-2", children: "₩1.2B+" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "월 평균 수익 지급액" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-bold text-[#45B7D1] mb-2", children: "98%" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "파트너 만족도" })
              ] })
            ] })
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/partners/products", className: "bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-10 h-10 text-[#FF6B6B] mb-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-4 group-hover:text-[#FF6B6B] transition-colors", children: "셀러 전용 상품" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-6", children: "파트너스 전용 상품을 구매하고 공유하세요. 특별한 할인과 혜택을 제공합니다." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-[#FF6B6B]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "바로가기" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-5 h-5 ml-2 transform group-hover:translate-x-2 transition-transform" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/partners/earnings", className: "bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "w-10 h-10 text-[#4ECDC4] mb-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-4 group-hover:text-[#4ECDC4] transition-colors", children: "수익/정산 내역" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-6", children: "실시간으로 수익을 확인하고 투명한 정산 내역을 확인하세요." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-[#4ECDC4]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "바로가기" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-5 h-5 ml-2 transform group-hover:translate-x-2 transition-transform" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/partners/guide", className: "bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-10 h-10 text-[#45B7D1] mb-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-4 group-hover:text-[#45B7D1] transition-colors", children: "파트너 가이드" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-6", children: "성공적인 파트너 활동을 위한 상세한 가이드와 팁을 확인하세요." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-[#45B7D1]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "바로가기" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-5 h-5 ml-2 transform group-hover:translate-x-2 transition-transform" })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-center mb-12", children: "자주 묻는 질문" }),
      ...
      ].map((faq, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-gray-900 mb-3", children: faq.question }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: faq.answer })
          ]
        },
        index2
      )) })
...
const PartnersProducts = () => {
  ...
  if (!user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-4", children: "로그인이 필요합니다" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/login",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-8", children: "파트너 전용 상품" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8", children: products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white rounded-xl shadow-card hover:shadow-card-hover transition-all overflow-hidden",
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: product.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl font-semibold text-primary mb-4", children: [
              product.price.toLocaleString(),
              "원"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
...
const PartnersEarnings = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-8", children: "수익 현황" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-medium text-gray-900 mb-2", children: "총 수익" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-primary", children: "₩1,234,567" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-medium text-gray-900 mb-2", children: "이번 달 수익" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-primary", children: "₩234,567" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-medium text-gray-900 mb-2", children: "판매된 상품" }),
...
const PartnersLinks = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-8", children: "공유 링크" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-medium text-gray-900 mb-4", children: "상품 공유 링크" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: cart.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: "p-2 text-gray-400 hover:text-primary transition-colors",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-5 h-5" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-medium text-gray-900 mb-4", children: "프로필 공유 링크" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-gray-50 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "내 프로필" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500", children: [
...
const PartnersGuide = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-8", children: "파트너 가이드" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "시작하기" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "계정 설정" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm", children: "프로필 정보를 입력하고 계정을 설정하세요." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "상품 선택" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm", children: "홍보하고 싶은 상품을 선택하세요." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "링크 생성" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm", children: "상품 링크를 생성하고 공유하세요." })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-card p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "수익 창출" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "수익률" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm", children: "판매 금액의 최대 10%까지 수익을 얻을 수 있습니다." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "정산" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm", children: "매월 1일과 15일에 정산이 이루어집니다." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCircle, { className: "w-5 h-5 text-primary mt-1 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: "수익 확인" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm", children: "실시간으로 수익 현황을 확인할 수 있습니다." })
            ] })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 bg-white rounded-xl shadow-card p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "자주 묻는 질문" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900 mb-2", children: "Q: 수익은 어떻게 계산되나요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "A: 공유한 링크를 통해 구매가 이루어지면 판매 금액의 최대 10%를 수익으로 받을 수 있습니다." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900 mb-2", children: "Q: 정산은 언제 이루어지나요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "A: 매월 1일과 15일에 정산이 이루어지며, 등록된 계좌로 입금됩니다." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900 mb-2", children: "Q: 수익은 어떻게 확인하나요?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "A: 파트너 대시보드에서 실시간으로 수익 현황을 확인할 수 있습니다." })
        ] })
      ] })
    ] }),
...
const Category = () => {
  ...
  const [categoryProducts, setCategoryProducts] = reactExports.useState([]);
  const categoryInfo = {
    "의류": {
      icon: Shirt,
      color: "bg-[#FF6B6B]",
  ...
  const Icon = ((_a = categoryInfo[category]) == null ? void 0 : _a.icon) || Shirt;
  const info = categoryInfo[category] || categoryInfo["의류"];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[40vh] min-h-[400px] overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-full max-w-7xl mx-auto px-4 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          animate: { opacity: 1, y: 0 },
          ...
          className: "max-w-2xl",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `${info.color} inline-flex items-center px-4 py-2 rounded-full text-white text-sm font-medium mb-4`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 mr-2" }),
              category
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-white/90", children: info.description })
          ]
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 py-16", children: categoryProducts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold text-gray-900", children: [
          "전체 상품 ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#FF6B6B]", children: categoryProducts.length })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: categoryProducts.map((product, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              animate: { opacity: 1, y: 0 },
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-16 h-16 mx-auto text-gray-400 mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-2", children: "상품 준비중" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 max-w-md mx-auto", children: [
            "현재 ",
            category,
            " 카테고리의 상품을 준비중입니다. 곧 멋진 상품들로 찾아뵙겠습니다."
          ] })
        ]
      }
    ) })
...
const MainLayout = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-kong-white relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "fixed top-0 left-0 right-0 bg-kong-white/95 backdrop-blur-sm z-[100] border-b border-kong-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold text-kong-black", children: "KONGDOOMALL" }) })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "p-2 text-kong-gray-700 hover:text-kong-gold transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/wishlist", className: "p-2 text-kong-gray-700 hover:text-kong-gold transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cart", className: "p-2 text-kong-gray-700 hover:text-kong-gold transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", className: "p-2 text-kong-gray-700 hover:text-kong-gold transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 20 }) })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-b bg-gradient-to-r from-kong-gold/10 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: "전체 메뉴" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setIsMenuOpen(false),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4", children: menuItems.map((section, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: index2 > 0 ? "mt-6" : "", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 bg-kong-gray-50 text-sm font-medium text-kong-gray-500", children: section.title }),
              section.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  onClick: () => setIsMenuOpen(false),
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-kong-gray-900", children: item.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-kong-gray-500 mt-0.5", children: item.description })
                  ]
                },
                item.name
              ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "pt-16 relative z-10", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-kong-black text-kong-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold mb-4", children: "KONGDOOMALL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kong-gray-400", children: "고급 브랜드몰 스타일의 쇼핑 경험을 제공하는 하이브리드 마켓플랫폼" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold mb-4", children: "고객센터" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-kong-gray-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "전화: 010-7123-6612" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "이메일: kojkhj614@naver.com" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "운영시간: 평일 10:00 - 18:00" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold mb-4", children: "회사정보" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-kong-gray-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "회사명: 콩두몰" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "대표: 총민혁" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "사업자등록번호: 123-45-67890" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold mb-4", children: "소셜 미디어" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-kong-gray-400 hover:text-kong-gold transition-colors", children: "Instagram" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-kong-gray-400 hover:text-kong-gold transition-colors", children: "Facebook" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-kong-gray-400 hover:text-kong-gold transition-colors", children: "YouTube" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 pt-8 border-t border-kong-gray-800 text-sm text-kong-gray-400", children: "© 2024 KONGDOOMALL. All rights reserved." })
    ] }) })
  ] });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/products/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetail, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/my-kongdoo", element: /* @__PURE__ */ jsxRuntimeExports.jsx(MyKongDoo, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/agency", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Agency, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/brand-zone", element: /* @__PURE__ */ jsxRuntimeExports.jsx(BrandZone, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/brand/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(BrandDetail, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/social-marketing", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SocialMarketing, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/partners", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Partners, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/partners/products", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PartnersProducts, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/partners/earnings", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PartnersEarnings, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/partners/links", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PartnersLinks, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/partners/guide", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PartnersGuide, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/category/:category", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Category, {}) }),
...
//# sourceMappingURL=index-dbd7f5a2.js.map
